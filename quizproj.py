...
questions = [
    ...
    {"q": "What is the full form of RAM?", "a": "Random Access Memory"},
    {"q": "What is the full form of ROM?", "a": "Read Only Memory"},
...
def end_quiz():
    ...
    result_label = Label(root, text=f"Your final score is: {score}/{total_marks_possible}", font=("Arial", 14), bg="bisque")
    result_label.pack(pady=20)

    if score >= passing_scope:
        pass_label = Label(root, text="Well done! You have passed the quiz!", font=("Arial", 14), fg="black", bg="bisque")
        pass_label.pack()
    else:
        fail_label = Label(root, text="Sorry! You didn't pass the quiz, better luck next time!", font=("Arial", 14), fg="black", bg="bisque")
        fail_label.pack()
